...
<html lang="zxx">
	<head>
		...
		<title>EZY - Responsive Multi-Purpose HTML5 Template 2.1.0</title>	
				...
				<div class="row align-items-center min-height-100vh">
					...
					<div class="col-md-6 p-0">
						<header id="header" class="p-4 p-md-5">
							<a href="index.html">
								<img alt="EZ" width="127" height="20" src="img/logo.png" class="appear-animation" data-appear-animation="fadeInRightShorter" data-plugin-options="{'accY': 100}">
							</a>
						</header>
							...
							<div class="row m-0">
								<div class="col-half-section pl-md-5">
									...
									<footer id="footer" class="bg-transparent">
										<p class="text-color-light-3 text-center text-lg-left appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Copyright © 2020 All Rights Reserved by Okler</p>
									</footer>
