	...
	<div role="main" class="main">
		<section class="page-header parallax overlay overlay-color-dark overlay-show overlay-op-8 appear-animation mb-0" data-appear-animation="fadeIn" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '120%', 'offset': 60}" data-image-src="<?php echo base_url(); ?>assets/img/parallax/header.jpg">
			<div class="container py-1 my-4">
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="font-weight-bold text-color-light">Our Services</h1>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col">
						<div class="steps steps-primary steps-style-2">
							<div class="dots appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1200">
								<img class="dots-mask" src="<?php echo base_url(); ?>assets/img/svg/steps-dots-bg-light.svg" alt="" />
							...
							<div class="item appear-animation" data-appear-animation="stepsFadeInUp" data-plugin-options="{'accY': -200}">
								<h2 class="item-title"><span>1.</span>Survey</h2>
								<p>We will arrange to survey of your premises free of charge and provide you with a detailed specification and quotation for your individual site.</p>
							</div>
							<div class="item appear-animation" data-appear-animation="stepsFadeInUp" data-appear-animation-delay="300" data-plugin-options="{'accY': -200}">
								<h2 class="item-title"><span>2.</span>Service Delivery</h2>
								<p>Our team will be ready to deliver your chosen service. We are on standby to deliver at your convenience any day of the week.</p>
							</div>
							<div class="item appear-animation" data-appear-animation="stepsFadeInUp" data-appear-animation-delay="600" data-plugin-options="{'accY': -200}">
								<h2 class="item-title"><span>3.</span>Sign Off</h2>
								<p>You will sign off that the task has been carried out to the expected service level expected.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-6 p-0 order-2 order-md-1">
					<section class="section bg-light-5 h-100">
						<div class="row justify-content-end m-0">
							<div class="col-half-section pr-md-5">
								<div class="mask overflow-hidden mb-3">
									<h2 class="font-weight-bold mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Post Construction</h2>
								</div>
								<div class="mask overflow-hidden mb-4">
									<p class="mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Construction cleaning can be very hard but at dryne group we have the solution for your problems. We clean and remove any debris, dust mud adhesive and other substances that are left over after your construction project leaving your building/residence sparkling clean.</p>
								</div>
							</div>
						</div>
					</section>
				...
				<div class="col-md-6 p-0 order-1 order-md-2">
					<div class="parallax h-100" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'minHeight': 371}" data-image-src="<?php echo base_url(); ?>assets/img/parallax/postconstruction.jpg"></div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 p-0">
